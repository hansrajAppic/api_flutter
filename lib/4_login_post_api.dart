...
var UserName;
var UserToken;
Future login_API(var email, var password) async {
  try {
        ...
        child: SingleChildScrollView(
          ...
          children: [
            const SizedBox(height: 25,),
             ...
             Center(child: Image.asset("assets/images/instaname.png",height: 90,)),
            ...
            onPressed: () {
             ...
             setState(() {
              ...
              login_API( emailController.text.trim(),  passwordController.text.trim()).then((value) {
                  Navigator.push(context, MaterialPageRoute(builder: (context) => GetApi2(),));
